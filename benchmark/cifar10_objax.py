...
def test(test_loader, predict_op):
    ...
    print("\tTest set:\tAccuracy: {}".format(num_correct/len(test_loader)))
...
def main(args):
    ...
    for epoch in range(args.epochs):
        ...
        print("Train Epoch: {}\t took {} seconds".format(epoch+1,  cur_epoch_time))
        ...
        if not args.disable_dp:
            epsilon = objax.privacy.dpsgd.analyze_dp(
                ...
                delta=args.delta)
            print("\tPrivacy: (epsilon = {}, delta = {})".format(epsilon, args.delta))
